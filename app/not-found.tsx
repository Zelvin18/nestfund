  ...
  return (
    <div style={{ minHeight: "70vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px 24px", textAlign: "center", backgroundColor: "#f8fafc" }}>
      ...
      <p style={{ fontSize: 16, color: "#64748b", maxWidth: 440, margin: "0 0 32px 0", lineHeight: 1.65 }}>
        The page you&apos;re looking for was moved, removed, or never listed. Head back to the market to keep exploring.
      </p>
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
        ...
        <Link href="/market" style={{ padding: "12px 24px", borderRadius: 10, border: "1.5px solid #e2e8f0", backgroundColor: "#fff", color: "#374151", fontSize: 15, fontWeight: 600, textDecoration: "none" }}>
          Browse Properties
        </Link>
      </div>
    </div>
