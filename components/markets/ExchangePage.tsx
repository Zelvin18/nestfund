...
type MarketType = "income" | "construction"
...
const exchangeListings: ExchangeListing[] = [
  {
    ...
    propertyValue: 245000000,
    currentSharePrice: 1380,
    originalSharePrice: 1280,
    priceChange: 7.81,
    apr: 11.0,
    occupancy: 100,
    availableBuyShares: 1427,
    availableSellShares: 342,
    lastTradePrice: 1375,
    lastTradeTime: "2 min ago",
    marketType: "income",
  },
  {
    id: "kololo-towers-ii",
    ...
    currentSharePrice: 5450,
    originalSharePrice: 5200,
    priceChange: 4.81,
    apr: 11.8,
    occupancy: null,
    availableBuyShares: 890,
    availableSellShares: 156,
    lastTradePrice: 5440,
  ...
  },
  {
    ...
    propertyValue: 184000000,
    currentSharePrice: 3280,
    originalSharePrice: 3200,
    priceChange: 2.50,
    apr: 12.8,
    occupancy: 96,
    availableBuyShares: 1369,
    availableSellShares: 201,
    lastTradePrice: 3270,
    lastTradeTime: "5 min ago",
    marketType: "income",
  },
  {
    ...
    propertyValue: 312000000,
    currentSharePrice: 985,
    originalSharePrice: 950,
    priceChange: 3.68,
    apr: 9.6,
    occupancy: 98,
    availableBuyShares: 2100,
    availableSellShares: 450,
    lastTradePrice: 980,
    lastTradeTime: "18 min ago",
    marketType: "income",
  },
]
