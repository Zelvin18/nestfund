...
export const demoOpportunities: Opportunity[] = [
  ...
  {
    id: "electric-boda-fleet",
    title: "Electric Boda Fleet — 50 Units",
    category: "assets",
    subcategory: "Asset Finance",
    description: "Financing a fleet of 50 electric boda bodas leased to vetted riders on daily payment plans, with battery-swap infrastructure partners in Kampala.",
    location: "Kampala, Uganda",
    operator: "Sample operator — demonstration record",
    image: "https://images.unsplash.com/photo-1558981285-6f0c94958bb6?w=900&q=80",
    fundingRequired: 450_000_000,
    fundingReceived: 0,
    minInvestment: 100_000,
    unitPrice: 10_000,
    ...
    riskLevel: "Moderate",
    status: "Coming Soon",
    revenueModel: "Riders make daily lease payments toward ownership. Net lease income after fleet management and maintenance is distributed to investors.",
    security: ["GPS-tracked assets", "Rider vetting & daily collections"],
    risks: ["Rider default rates may exceed projections.", "Battery and maintenance costs may rise.", "Regulation of boda transport may change."],
    expectedExit: "Fleet lease-to-own completion (est. 30 months)",
    demo: true,
  },
  {
    id: "pharma-distribution-contract",
    title: "Pharmaceutical Distribution Contract",
    category: "cashflow",
    subcategory: "Contract Finance",
    description: "Financing the distribution of essential medicines under a 6-month supply contract with a network of licensed pharmacies across central Uganda.",
    location: "Central Region, Uganda",
    operator: "Sample operator — demonstration record",
    image: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=900&q=80",
    fundingRequired: 220_000_000,
    fundingReceived: 0,
    minInvestment: 100_000,
    unitPrice: 10_000,
    ...
    riskLevel: "Moderate",
    status: "Coming Soon",
    revenueModel: "Capital funds medicine procurement and distribution under the signed contract. Pharmacy payments on delivery cycles repay investors.",
    security: ["Signed distribution contract", "Licensed counterparties"],
    risks: ["Pharmacies may pay later than their credit terms.", "Supply chain delays could stretch the cycle."],
    expectedExit: "End of contract term (est. 6 months)",
    demo: true,
  },
]
